...
def get_user(login: str, password: str, host: str, base: str = None, identity: str | DSDict = None,
             ldap_filter: str = None, properties: str | list | tuple = None,
             search_scope: DS_TYPE_SCOPE = "subtree") -> DSDict:
...
create_post("get_user", SpecData, get_user, router_ds)
