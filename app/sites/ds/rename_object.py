...
def rename_object(login: str, password: str, host: str | list[str], identity: str | dict, new_name: str,
...
create_post(endpoint="rename_object", func=rename_object, access=AppConfig.SUCKERS_DS__LIST_OF_PERMITTED,
