...
def remove_object(login: str, password: str, host: str | list[str], identity: str | dict, base: str = None,
                  log_level: int = None):
...
create_post(endpoint="remove_object", func=remove_object, access=AppConfig.SUCKERS_DS__LIST_OF_PERMITTED,
