...
def set_contact(login: str, password: str, host: str | list[str], identity: str | dict, base: str = None,
...
create_post(endpoint="set_contact", func=set_contact, access=AppConfig.SUCKERS_DS__LIST_OF_PERMITTED,
