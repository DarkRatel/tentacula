...
def set_computer(login: str, password: str, host: str | list[str], identity: str | dict, base: str = None,
...
create_post(endpoint="set_computer", func=set_computer, access=AppConfig.SUCKERS_DS__LIST_OF_PERMITTED,
