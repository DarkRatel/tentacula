...
def get_contact(login: str, password: str, host: str | list[str], base: str = None, identity: str | dict = None,
...
create_post(endpoint="get_contact", func=get_contact, access=AppConfig.SUCKERS_DS__LIST_OF_PERMITTED,
