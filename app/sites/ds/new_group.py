...
def new_group(login: str, password: str, host: str | list[str], path: str, name: str, sam_account_name: str,
...
create_post(endpoint="new_group", func=new_group, access=AppConfig.SUCKERS_DS__LIST_OF_PERMITTED,
