...
def get_computer(login: str, password: str, host: str | list[str], base: str = None, identity: str | dict = None,
...
create_post(endpoint="get_computer", func=get_computer, access=AppConfig.SUCKERS_DS__LIST_OF_PERMITTED,
