...
def move_object(login: str, password: str, host: str | list[str], identity: str | dict, target_path: str, base: str = None,
                log_level: int = None):
...
create_post(endpoint="move_object", func=move_object, access=AppConfig.SUCKERS_DS__LIST_OF_PERMITTED,
