...
def remove_group(login: str, password: str, host: str | list[str], identity: str | dict, base: str = None,
                 log_level: int = None):
...
create_post(endpoint="remove_group", func=remove_group, access=AppConfig.SUCKERS_DS__LIST_OF_PERMITTED,
