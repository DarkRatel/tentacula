...
def remove_contact(login: str, password: str, host: str | list[str], identity: str | dict, base: str = None,
                   log_level: int = None):
...
create_post(endpoint="remove_contact", func=remove_contact, access=AppConfig.SUCKERS_DS__LIST_OF_PERMITTED,
