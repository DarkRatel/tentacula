...
1. suсkers (присоски) - инстанс использующий POST-протокол, с заранее описанными требованиями и функционалом, который
...
- `Dockerfile` - docker-файл описывающий запуск приложения в виртуальной среде, имитирующей ПРОД (актуально для
  разработки);
